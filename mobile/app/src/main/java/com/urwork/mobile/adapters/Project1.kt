...
class Project1(private val ctx: Context, private var topTitleisProgress: Boolean = false, private var mList: ArrayList<ProjectModelData>) : RecyclerView.Adapter<Project1.ViewHolder>() {
